...
# A Machine Learning Method to detect the 2'-O-methylation(Nm) in Nanopore direct RNA-seq(Codes developed on the top of  Nanom6A (Gao et al. Genome Biology. 2021))
